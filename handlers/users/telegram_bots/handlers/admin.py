...
from handlers.users.telegram_bots.analysis.vizual_part import umumit_analitika, data_science_analitika, \
    full_stack_analitika, soft_engineer_analitika, mentors_analysis
from handlers.users.telegram_bots.handlers import others
from handlers.users.telegram_bots.handlers.others import add_mentor_query, mentor_delete_query, get_users, add_admin, \
    delete_admin, edit_password, add_user_access, check_analysis_users, delete_user_access
from handlers.users.telegram_bots.keyboards import admin_kb, inlines
from handlers.users.telegram_bots.keyboards.admin_kb import main_kb, edit_password_kb, main_analysis, access_user_kb, \
    view_analysis_kb
from handlers.users.telegram_bots.keyboards.inlines import analysis_direction, all_ds_inline, all_ds_list, \
